////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                //
//  filename : cabsTracker.js                                                                                      //
//  author: Prateek Pandey(Digital)                                                                               //
//  language: NodeJs                                                                                              //
//  description: This is the file that is reponsible for generating cabs geolocation information                   //
//  input: NA                                                                                                     //
//  output: NA                                                                                                    //
//                                                                                                                //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  setInterval( () => {
    ...
    navigator.geolocation.getCurrentPosition(pos => {
      const { latitude: lat, longitude: lng} = pos.coords
          , type = 'cabs';    // setting the type as cabs to have a different marker
