////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                //
//  filename : womanTracker.js                                                                                      //
//  author: Prateek Pandey(Digital)                                                                               //
//  language: NodeJs                                                                                              //
//  description: This is the file that is reponsible for generating woman geolocation information                   //
//  input: NA                                                                                                     //
//  output: NA                                                                                                    //
//                                                                                                                //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  setInterval( () => {
    ...
    navigator.geolocation.getCurrentPosition(pos => {
      const { latitude: lat, longitude: lng} = pos.coords
          , type = 'woman'; // setting the type as woman to have a different marker
